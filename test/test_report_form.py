...
class TestReportForm(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ReportForm:
        """Test ReportForm
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReportForm`
        """
        model = ReportForm()
        if include_optional:
            return ReportForm(
