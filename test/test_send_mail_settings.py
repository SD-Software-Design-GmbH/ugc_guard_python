...
class TestSendMailSettings(unittest.TestCase):
    """SendMailSettings unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendMailSettings:
        """Test SendMailSettings
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendMailSettings`
        """
        model = SendMailSettings()
        if include_optional:
