...
```sh
pip install git+https://github.com/SD-Software-Design-GmbH/ugc_guard_python
```
...
```bash
openapi-generator-cli generate -i https://api.ugc-guard.com/openapi.json -g python  --additional-properties=packageName=ugc_guard_python,projectName=ugc_guard_python,packageVersion="1.0.0", -o tmp/python/
```
