...
class ContentApi:
    ...
    def _delete_content_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/content/{content_id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_all_content_of_report(
        ...
        _param = self._get_all_content_of_report_serialize(
            report_id=report_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_all_content_of_report_with_http_info(
        self,
        report_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_all_content_of_report_without_preload_content(
        self,
        report_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _get_all_content_of_report_serialize(
        self,
        report_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/content/{report_id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _get_content_by_id_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/content/content/{content_id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
