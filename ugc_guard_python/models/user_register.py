...
class UserRegister(BaseModel):
    ...
    password: Annotated[str, Field(min_length=8, strict=True, max_length=128)] = Field(description="Password for the user. Must be at least 8 characters long.")
    __properties: ClassVar[List[str]] = ["id", "username", "email", "name", "avatar_id", "avatar_url", "password"]
