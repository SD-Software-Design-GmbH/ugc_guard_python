...
class ReportLogWithInvoker(BaseModel):
    """
    ...
    report_id: StrictStr
    report_invoker: Optional[UserBase] = None
    __properties: ClassVar[List[str]] = ["id", "created_at", "message", "content", "log_type", "invoker_id", "organization_id", "report_id", "report_invoker"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of report_invoker
        if self.report_invoker:
            _dict['report_invoker'] = self.report_invoker.to_dict()
        ...
        # set to None if report_invoker (nullable) is None
        # and model_fields_set contains the field
        if self.report_invoker is None and "report_invoker" in self.model_fields_set:
            _dict['report_invoker'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "report_invoker": UserBase.from_dict(obj["report_invoker"]) if obj.get("report_invoker") is not None else None
        })
        return _obj
