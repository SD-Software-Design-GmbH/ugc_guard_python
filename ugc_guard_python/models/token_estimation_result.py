...
class TokenEstimationResult(BaseModel):
    ...
    """ # noqa: E501
    input_tokens_estimation: StrictInt
    estimated_costs: Union[StrictFloat, StrictInt]
    model: AiModel
    __properties: ClassVar[List[str]] = ["input_tokens_estimation", "estimated_costs", "model"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "input_tokens_estimation": obj.get("input_tokens_estimation"),
            "estimated_costs": obj.get("estimated_costs"),
