...
class ComparedModuleState(BaseModel):
    """
    ...
    prior: ModuleStats
    prior_date: datetime
    __properties: ClassVar[List[str]] = ["now", "prior", "prior_date"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of now
        if self.now:
            _dict['now'] = self.now.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "now": ModuleStats.from_dict(obj["now"]) if obj.get("now") is not None else None,
            "prior": ModuleStats.from_dict(obj["prior"]) if obj.get("prior") is not None else None,
            "prior_date": obj.get("prior_date")
        })
        return _obj
