...
class PaginatedResultWebhookLogBase(BaseModel):
    """
    ...
    items: List[WebhookLogBase] = Field(description="List of items returned in the response following given criteria")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "count": obj.get("count"),
            "items": [WebhookLogBase.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
