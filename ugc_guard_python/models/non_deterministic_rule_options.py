...
class NonDeterministicRuleOptions(BaseModel):
    """
    Options for non-deterministic rules, such as AI models.
    """ # noqa: E501
    id: Optional[StrictStr] = None
    model_name: Optional[StrictStr] = None
    prompt_template: Optional[StrictStr] = Field(default=None, description="Template for the prompt used in the AI model, allowing dynamic content insertion")
    __properties: ClassVar[List[str]] = ["id", "model_name", "prompt_template"]
